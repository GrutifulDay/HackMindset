...
export function createUntruthVotingWindow() {
  ...
  listItems.forEach((text) => {
    ...
    icon.addEventListener("click", () => {
      ...
      icon.src = isSelected.value ? "../assets/icons/mark-on.svg" : "../assets/icons/mark-off.svg";
    });
  ...
  submitButton.addEventListener("click", async () => {
    ...
    if (isAbuse) {
      ...
      increaseUntruthVote();
      createFeedbackUntruth(
        lang === "cz" ? "Děkujeme za nahlášení chyby 👍" : "Thank you for reporting the error. 👍"
      );
    }
